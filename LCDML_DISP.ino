...
/* ******************************************************************** */
{
  ...
  if (LCDML_DISP_update()) {
    ...
    uint8_t n_max = (LCDML.getChilds() >= _LCDML_u8g_rows) ? ((_LCDML_u8g_rows > _LCDML_u8g_rows_max) ? _LCDML_u8g_rows : _LCDML_u8g_rows_max) : (LCDML.getChilds());
       // Serial.print("LCDML.getChilds(): "); Serial.println(LCDML.getChilds());
       // Serial.print("_LCDML_u8g_rows: "); Serial.println(_LCDML_u8g_rows);
       // Serial.print("_LCDML_u8g_rows_max: "); Serial.println(_LCDML_u8g_rows_max);
    ...
    do {
      ...
      for (uint8_t n = 0; n < n_max; n++)
      {
        ...
        if (n == LCDML.getCursorPos()) {
         ...
         // Serial.print("n: "); Serial.print(n);Serial.print(" - LCDML.content[n]: "); Serial.println(LCDML.content[n]);
        // set content
          //if(LCDML.content_id[n]==3){
         //   u8g.drawStr( 10, _LCDML_u8g_font_h * (n + 1), "Teste");        
        // }else{        
